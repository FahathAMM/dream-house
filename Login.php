...
<?php include('header.php') ; ?>
    ...
    <section class="hero-section home-page set-bg" data-setbg="img/bg.jpg">
      ...
      <div class="container hero-text text-white">
          ...
          <h1  style=" font-weight: 800;">Dream Home</h1>
      </div>
    </section>
...
<div>
        ...
        <div class="logform">
            ...
            <style type="text/css">
                ...
                <form action="login_script.php" class="log-in" method="post" name="frm"> 
                  <h4>HOUSE <span>RENT</span></h4>
            ...
            <style type="text/css">
                ...
                .st1{fill:#010101;}
                  ...
                  <div >
                    ...
                    <button style="margin-left: 140px; " class="buttonl" name="login" type="submit"   >Log in</button>
            
                  </div>
                 
                 <a style="color:grey"   href="clientregister.php" class="discrete" target="_blank">Register</a>
