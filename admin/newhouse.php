    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div>
                ...
                <h2 style="  margin:0px 0 5px 0;">NEW HOUSE</h2>
            ...
            <div class="w3-container">
                ...
                <table class="table  table-bordered table-striped table-sm table-advandce table-hover">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-success"
                                        href="status.php?houseid=<?php echo $row['houseid'] ?>"><i
                                            class="fa fa-plus-square"></i></a>
                                    <a class="btn btn-danger" href="delete.php?houseid=<?php echo $row['houseid'] ?>"><i
